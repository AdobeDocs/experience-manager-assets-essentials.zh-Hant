...
如果您已在環境中佈建具有 OpenAPI 功能的 Dynamic Media，則您將資產標記為 `Approved` 時，Experience Manager Assets 便會立即產生一個公用 URL。
...
* [觀看影片以了解如何在 Assets Essentials 中管理資產](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/basics/managing.html?lang=zh-Hant)
