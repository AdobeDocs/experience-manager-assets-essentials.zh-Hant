...
description: 瞭解如何在「資產」檢視中管理標籤。 標籤可協助您更有效率地將可瀏覽和搜尋的資產分類。
...
>title="管理標記"
>abstract="標籤可協助您更有效率地將可瀏覽和搜尋的資產分類。 管理員可以使用階層式標籤結構，這有助於套用相關中繼資料、分類資產、支援搜尋、重複使用標籤、改善可發現性等等。"

標籤可協助您更有效率地將可瀏覽和搜尋的資產分類。 標籤有助於將適當的分類法傳播給其他使用者和工作流程。

控管辭彙的平面清單可能會隨著時間而變得無法管理。 管理員可以使用階層式標籤結構，這有助於套用相關中繼資料、分類資產、支援搜尋、重複使用標籤、改善可發現性等等。
