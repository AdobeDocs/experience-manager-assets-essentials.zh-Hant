---
title: 在  [!DNL Assets Essentials] 中將資產重新命名及大量重新命名
description: 了解如何使用新的 Assets UI (Assets Essentials) 將大量資產重新命名。 此 UI 可能同時將多個資產重新命名。
role: User
...
1. 採取下列其中一種方式，將資產或資料夾重新命名：
   ...
   * 選取資產或資料夾，然後在上方選單中按一下![重新命名圖示](assets/do-not-localize/rename-icon.png)「**[!UICONTROL 重新命名]**」。
...
1. [選用]按一下![復原圖示](assets/do-not-localize/undo.svg)以還原或取消您執行的上一個動作。

1. 在「[!UICONTROL 新名稱預覽]」欄位中確認您的變更內容，然後按一下「**[!UICONTROL 儲存]**」。

   ![AI 大量重新命名](assets/ai-bulk-rename.png)
