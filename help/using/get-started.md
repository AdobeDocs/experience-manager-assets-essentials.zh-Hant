...
| 與其他解決方案整合 | <ul> <li>[使用  [!DNL Adobe Journey Optimizer]](/help/using/integration.md) 中的資產選擇器</li> <li>[[!DNL Adobe Asset Link] 的 [!DNL Creative Cloud]](/help/using/integration.md)</li> <li>[&#x200B; 與  [!DNL Adobe Workfront]](/help/using/integration.md) 整合</li> </ul> |

## 後續步驟 {#next-steps}

* [觀看開始使用Assets Essentials的相關影片](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/getting-started.html?lang=zh-Hant)
