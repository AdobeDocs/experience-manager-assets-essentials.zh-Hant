...
使用內嵌的[!DNL Adobe Express]視訊快速動作，為Assets使用者輕鬆建立視訊內容的變體。 由[!DNL Adobe Express]提供支援的[!DNL Assets Essentials]中的快速動作可提供方便使用的視訊編輯選項，包括裁切視訊、調整視訊大小、修剪視訊，以及將視訊轉換成GIF。
...
5. 按一下「**[!UICONTROL 套用]**」。
   ...
   已裁切的視訊可供下載。 您可以將編輯後的資產儲存為相同資產的新版本，或儲存為新資產。![使用Adobe Express](/help/using/assets/adobe-express-save-video.png)儲存視訊

### 調整視訊大小 {#resize-video-using-express}

DAM中的最終視訊內容通常需要調整大小，才能發佈到特定管道。[!DNL Assets Essentials] 可讓您輕鬆調整視訊大小以符合常見社交頻道所需的維度，您也可以根據自訂解析度調整大小。 若要使用[!DNL Assets Essentials]調整視訊大小，請執行下列步驟：
...
5. 按一下「**[!UICONTROL 套用]**」。
   ...
   ![使用Adobe Express將視訊轉換成GIF](/help/using/assets/adobe-express-convert-video-to-gif.png)
