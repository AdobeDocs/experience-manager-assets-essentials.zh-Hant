...
* [具備 Experience Cloud 解決方案之 Adobe Admin Console 的存取權](https://experienceleague.adobe.com/docs/core-services/interface/administration/admin-getting-started.html)
