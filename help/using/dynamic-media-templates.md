...
* ![DM範本](/help/using/assets/add-image.svg)：按一下以將影像新增至畫布。
...
1. 按一下&#x200B;**[!UICONTROL 儲存]**。
   ![即時內容建立](/help/using/assets/parameterise-a-layer.png)
...
1. 按一下&#x200B;**[!UICONTROL 複製URL]**。 **[!UICONTROL 複製URL]**&#x200B;對話方塊隨即顯示。 選取並複製顯示的URL。 請注意，URL中的第一個引數在問號&#x200B;**(？)**&#x200B;之後開始 而機碼值組開頭為&#x200B;**$**，結尾為&#x200B;**&amp;**。 金鑰和值由等號&#x200B;**(=)**&#x200B;分隔，金鑰在左側，值在右側。
